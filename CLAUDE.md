...
> `~/GloomsHub/docs/BACKLOG.md` FIRST — the short list of what's actually open — then
> SUITE-STATE.md (settled state), FINDINGS.md (unproven diagnosis, evidence-tagged) and
> CONTRACTS.md, as the job needs them. **Phase C (2026-07-24) migrated THIS repo's
...
> **Belongs in `~/GloomsAuras` / `~/GloomsOverlays`:** anything about those tools.
