...
-- Apply to bars — the per-bar preset assignment grid (the owner's architecture:
...
local function buildApplySection(bf, s)
  ...
  for i, bar in ipairs(GB.BARS) do
    ...
    -- (the owner: with several bars visible it's hard to tell which is which).
...
local function BuildPanel()
  ...
  -- Footer profile switcher (was an unwired increment-1 stub — the owner): shows
