...
-- + what triggers it in-game + clickable section links (the owner's copy, session 12).
local STATE_DESC = {
...
local function buildCooldownSection(bf, s)
  ...
  -- font/size/colour/offsets (the numbers can crowd the keybind — the owner, session 12).
