...
function Glows:Init()
  ...
  -- glow stuck on the previously-checked button (the owner: assist→passive kept the
  ...
  -- it IS Blizzard's behavior (the owner confirmed), and their own glow is just so
