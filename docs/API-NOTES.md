...
- **A full-bleed bundled circle PNG ALSO showed flattened + BLURRED tangents** (sharp corners) — VERIFIED 2026-07-18. Working hypothesis (⚠ fix pending QA): **edge-clamp filtering bleed** where the shape touches the texture canvas edge; cure = transparent padding around the shape (current art: radius 240/256) + oversize the mask region to compensate. **Rule: all mask/glow art must carry transparent edge padding.**
