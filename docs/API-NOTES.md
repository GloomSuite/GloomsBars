...
**Foreign members:** `EQOL_ActionBarName` — a third-party addon (EQOL/EnhanceQoL family) also decorates these buttons on the owner's client. ArcUI also loaded. QA confound awareness.
