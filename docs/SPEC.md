...
> The owner will expand this in the new project. Everything here is *discussed / reasoned*, not yet built
...
## Open decisions (the owner to resolve in the new project)
...
## How to work with the owner (carries over — also in his global memory)
