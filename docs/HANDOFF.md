...
- **2026-07-18: the owner's HotKey text is styled by a third-party addon** (Lato @ 16
  thick-outline, green, "s-R"-style modifier abbreviations — `/gb fontinfo`). The
  font FILE is Platynator's (a **nameplate** addon — the owner's correction; it merely
  ...
  absorbing modifier abbreviations as a feature); then the owner disables that styling.
