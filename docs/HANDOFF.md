...
- **2026-07-18: the owner's HotKey text is owned by Platynator** (keybind-styling addon:
  ...
  modifier abbreviations as a feature); then the owner disables Platynator's styling.
