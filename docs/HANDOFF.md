...
The open items are SCOPE CALLS for the owner (ask which he wants): (a) **Name-text override** (the macro-name
...
The owner is keeping an eye out; same for finish-flash behaviour over long rotations.
